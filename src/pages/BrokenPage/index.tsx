...
const BrokenPage = () => {
  return (
    <AppLayout>
      <section className="mx-auto flex min-h-[calc(100vh-18rem)] max-w-2xl items-center justify-center overflow-hidden rounded-3xl border border-[#dce4ff] bg-white px-6 py-12 text-center shadow-sm">
