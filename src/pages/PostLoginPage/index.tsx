...
const PostLoginPage = () => {
  return (
    <div className="gradient flex min-h-screen items-center justify-center px-4 py-10 sm:px-6 md:px-8">
      <div className="post-login-card w-full max-w-lg rounded-[2rem] border border-white/30 bg-white/90 p-6 shadow-2xl backdrop-blur-xl sm:p-8 md:p-10">
        <div className="mb-8 text-center">
          <p className="text-sm font-bold uppercase tracking-[0.22em] text-blue">Krenimo</p>
